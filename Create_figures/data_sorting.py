...
data = np.load('KM_coefficients.npz')


edges_1d = data['edges_1d'],
drift_1d = data['kmc_1d_drift'],
diffusion_1d = data['kmc_1d_diffusion'],
edges_2d = data['edges_2d'],
kmc_2d = data['kmc_2d'],

c_1_model1 = data['c_1_model1'],
c_1_model2 = data['c_1_model2'],

p_3_model3 = data['p_3_model3'],
p_1_model3 = data['p_1_model3'],

epsilon_model2 = data['epsilon_model2'],
epsilon_model1 = data['epsilon_model1'],
d_2_model3 = data['d_2_model3'],
d_0_model3 = data['d_0_model3'],
